...
class WalkingState:
    ...
    def draw(boy):
        ...
        boy.font.draw(sx - 40, sy + 40, 'ball : (%d)' % (boy.ball), (255, 255, 0))
...
class Boy:
    ...
    def handle_collision(self,_b, _group):
        self.ball += 1
        game_world.remove_collision_object(_b)
        game_world.remove_object(_b)
        del _b